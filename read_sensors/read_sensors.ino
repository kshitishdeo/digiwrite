...
LSM9DS0 dof1(MODE_I2C, LSM9DS0_G, LSM9DS0_XM,1);
LSM9DS0 dof2(MODE_I2C, LSM9DS0_G, LSM9DS0_XM,2);
...
void dispRegisters(void){
  int oreg[7] = {
    0x00,0x3F,0x2A,0x02  };
  char const* oregname[] = {"Product_ID","Inverse_Product_ID","SROM_Version","Motion"  };
  byte regres;
...
void readXY(int *xy){
  ...
  Serial.print(" ");
   ...
   Serial.print(dof1.gx);
   Serial.print(" ");
   Serial.print(dof1.gy);
   Serial.print(" ");
   Serial.print(dof1.gz);
   Serial.print(" ");

  dof1.readAccel();

   Serial.print(dof1.ax);
   Serial.print(" ");
   Serial.print(dof1.ay);
   Serial.print(" ");
   Serial.print(dof1.az);
   Serial.print(" ");
  ...
  dof2.readAccel();
   ...
   Serial.print(dof2.ax);
   Serial.print(" ");
   Serial.print(dof2.ay);
   Serial.print(" ");
   Serial.print(dof2.az);
   Serial.print(" ");
