...
#include "SFE_LSM9DS0_Modified.h"
...
LSM9DS0::LSM9DS0(interface_mode interface, uint8_t gAddr, uint8_t xmAddr, int index)
{
...
uint16_t LSM9DS0::begin(gyro_scale gScl, accel_scale aScl, mag_scale mScl, 
						gyro_odr gODR, accel_odr aODR, mag_odr mODR, int index)
{
...
//Wire.begin();	// Initialize I2C library
 if (i == 1)
	...
	{
	  Wire.begin(I2C_MASTER, 0x00, I2C_PINS_18_19, I2C_PULLUP_INT, I2C_RATE_400);
	  Wire.pinConfigure(I2C_PINS_16_17, I2C_PULLUP_INT);
        }
